...
git add Dockerfile
git commit -m "Pushing dockerfile"
...
docker build .
docker login
docker tag ce48722752ad knvanzweel/computational-workflows
docker push knvanzweel/computational-workflows
```
...
docker run -it -v $pwd/root/shared -w /root/shared knvanzweel/computational-workflows python3 -m pytest
...
# Add, commit and push python files to Github
git add wallet.py
git add test_wallet.py

git commit -m "...cannot remember the comment"
git push -u origin main

# Copied files from host to the running docker container
docker cp wallet.py 7d24bc93c344:root/shared
docker cp test_wallet.py 7d24bc93c344:root/shared
